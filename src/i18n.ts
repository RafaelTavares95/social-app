  ...
  en: {
    translation: {
      auth: {
        ...
        good: 'Good',
        strong: 'Strong',
        accountCreatedSuccess: 'Account created successfully! Please check your email to confirm your account.',
  ...
  pt: {
    translation: {
      auth: {
        ...
        good: 'Boa',
        strong: 'Forte',
        accountCreatedSuccess: 'Conta criada com sucesso! Por favor, verifique seu e-mail para confirmar sua conta.',
        createAccountError: 'Falha ao criar conta. Por favor, tente novamente.',
        success: 'Sucesso!',
        redirectingToLogin: 'Redirecionando para o login em',
        seconds: 'segundos',
        goToLogin: 'Ir para o Login Agora',
        emailConfirmation: {
